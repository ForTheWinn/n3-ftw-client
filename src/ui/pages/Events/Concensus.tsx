        ...
        <div className="column is-8 is-offset-2">
          <div className="box is-shadowless">
            <div className="is-block mb-5">
              <h1 className="title is-spaced">Concensus 2023</h1>
              <p className="subtitle">
                ...
                for our visitors: gift cards loaded with NEO private keys and
                exclusive rewards for those who dive into our app and engage
                with our community.
              </p>
            </div>
            <div className="is-block mb-5">
              <Space>
                <img src="/events/concensus-discord-invite.png " />
                <h1 className="title">
            ...
            <div className="content">
              ...
              <p>NEPs, Keys, Neo Boyz, Neo Boyz Ring</p>
            </div>
          </div>
        </div>
      </div>
